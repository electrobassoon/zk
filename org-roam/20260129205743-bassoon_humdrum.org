...
* Humdrum User Guide Tracker
  - **Status**: Not started.
  - **Goal**: Reach Chapter 5 (Basic Analysis) to justify the encoding effort.
  - [[https://www.humdrum.org/guide/ch01/][Link: Humdrum Guide Chapter 1]]

* Next Session Breadcrumbs
  - Breadcrumb: Movement 1 is done, movement 2 is in musescore proofing. Movement 3 is probably in original omr file, but it's split into tifs with the above workflow to compare.
  - *Current Task*: Continue movement 3 processing in audiveris. Needs the editing phase.
